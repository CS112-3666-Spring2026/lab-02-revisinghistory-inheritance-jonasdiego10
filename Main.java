...
public class Main {
	public static void main(String[] args) {
		...
		String incarcerationOriginal = "During World War II, many Japanese Americans were relocated for national security reasons following the attack on Pearl Harbor.";

		Date incarcerationDate = new Date(2, 19, 1942);

		String incarcerationRevised = "On February 19, 1942, President Franklin D. Roosevelt signed the Executive Order 9066. This led to the forced removal and arrest of Japanese Americans, which included many US citizens, from the West Coast. The policy was driven by wartime fear, racism, and suspicion rather than proof of individual wrongdoing. More than 120,000 people who were of Japanese descent were detained in camps across the United States.";

		String incarcerationCitation = "https://www.archives.gov/research/aapi/ww2/incarceration";

		RevisedHistoricalEvent japaneseIncarceration = new RevisedHistoricalEvent(
        		incarcerationOriginal,
        		incarcerationDate,
        		incarcerationRevised,
        		incarcerationCitation
		);
